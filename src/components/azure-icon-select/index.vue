<template>
  <div>
    <el-popover
      ...
      width="300"
      trigger="click">
      <div class="header azure-clearfix azure-mb-10" v-if="clearable">
        <el-button type="danger" icon="el-icon-delete" size="mini" class="azure-fr" @click="selectIcon()">清空</el-button>
      </div>
      <el-input
        v-model="searchText"
        :clearable="true"
