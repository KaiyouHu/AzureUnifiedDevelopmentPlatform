  ...
  <azure-container>
    <el-tabs>
      ...
      <el-tab-pane label="侧栏菜单">
        ...
        <azure-highlight :code="JSON.stringify(aside, null, 2)"/>
      </el-tab-pane>
    </el-tabs>
  </azure-container>
</template>
