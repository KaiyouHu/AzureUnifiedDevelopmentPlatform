<template>
  <el-card shadow="never" class="azure-mb">
    <div slot="header" class="azure-clearfix">
      <el-button type="text" size="mini">{{title}}</el-button>
      <el-tooltip content="重新 mock 数据" placement="top-end">
        <el-button type="primary" size="mini" @click="$emit('reload')" class="azure-fr">刷新</el-button>
      </el-tooltip>
    </div>
    <el-row :gutter="10">
      <el-col :span="12">
        <div class="col col-l">
          <azure-highlight :code="code"/>
        </div>
      </el-col>
      <el-col :span="12">
        <div class="col col-r">
          <azure-highlight :code="mock"/>
        </div>
      </el-col>
    </el-row>
  </el-card>
