  ...
  <azure-container>
    <el-row>
      <el-col :span="12">
        ...
        <h1 class="azure-mt-0">基础用法</h1>
        <el-row>
          <el-checkbox v-model="checked1">备选项1</el-checkbox>
          <el-checkbox v-model="checkeazure">备选项2</el-checkbox>
        </el-row>

        <h1>禁用状态</h1>
        <el-row>
          <el-checkbox v-model="checked1" disabled>备选项1</el-checkbox>
          <el-checkbox v-model="checkeazure" disabled>备选项2</el-checkbox>
        </el-row>
      ...
      <el-col :span="12">
        ...
        <div>
          ...
          <el-checkbox v-model="checkeazure" label="备选项2" border></el-checkbox>
        </div>
        <div style="margin-top: 20px">
          <el-checkbox v-model="checked1" label="备选项1" border size="medium"></el-checkbox>
          <el-checkbox v-model="checkeazure" label="备选项2" border size="medium"></el-checkbox>
        </div>
        <div style="margin-top: 20px">
