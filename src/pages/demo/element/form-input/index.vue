<template>
  <azure-container>
    ...
    <el-row>
      <el-col :span="12">
        <p class="azure-mt-0">属性方式</p>
        <el-input
          placeholder="请选择日期"
          suffix-icon="el-icon-date"
          v-model="input2"
          class="input-demo-200 azure-mr-10">
        </el-input>
        <el-input
          placeholder="请输入内容"
          prefix-icon="el-icon-search"
          v-model="input21"
          class="input-demo-200 azure-mt-10">
        </el-input>
      </el-col>
      <el-col :span="12">
        <p class="azure-mt-0">slot 方式</p>
        <el-input
          placeholder="请选择日期"
          v-model="input22"
          class="input-demo-200 azure-mr-10">
    ...
    <div>
      <el-input
        ...
        placeholder="请输入内容"
        v-model="textarea3"
        class="azure-mt-10 input-demo-400">
      </el-input>
    </div>
    ...
    <el-row class="demo-autocomplete">
      <el-col :span="12">
        <p class="azure-mt-0">激活即列出输入建议</p>
        <el-autocomplete
          class="input-demo-200"
          v-model="state1"
      ...
      <el-col :span="12">
        <p class="azure-mt-0">输入后匹配输入建议</p>
        <el-autocomplete
          class="input-demo-200"
          v-model="state2"
          :fetch-suggestions="querySearch"
