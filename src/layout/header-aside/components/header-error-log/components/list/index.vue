<template>
  <el-table
    ...
    <el-table-column type="expand">
      <div slot-scope="props" class="azure-error-log-list__expand-group">
        <expand-item
          :type="props.row.type"
          title="类型"
    ...
    <el-table-column
      ...
      <template slot-scope="scope">
        <el-tag
          ...
          size="mini"
          type="danger">
          <azure-icon name="bug"/> Bug
        </el-tag>
        <el-tag
          v-else
          size="mini"
          type="info">
          <azure-icon name="dot-circle-o"/> Log
        </el-tag>
      </template>
    </el-table-column>
...
.azure-error-log-list__expand-group {
  .azure-error-log-list__expand {
    padding-left: 20px;
    margin-bottom: 10px;
    &:last-child {
      margin-bottom: 0px;
    }
    .azure-error-log-list__expand-title {
      font-size: 16px;
      font-weight: bold;
      margin-top: 0px;
      margin-bottom: 10px;
    }
    .azure-error-log-list__expand-value {
      font-size: 12px;
      margin-top: 0px;
      margin-bottom: 0px;
    }
  }
  .azure-error-log-list__expand--log {
    border-left: 4px solid $color-info;
  }
  .azure-error-log-list__expand--error {
